...
def train_model(csv_file):
    ...
    # RFE
    rfe = RFE(RandomForestClassifier(), n_features_to_select=10, step=5)
    rfe.fit(X_train, y_train)
    print("Cette instruction affiche un tableau de booléens qui indique les caractéristiques sélectionnées. Les caractéristiques ayant la valeur True sont celles qui ont été sélectionnées.")
    print(rfe.support_)
    print("Cette instruction affiche un tableau qui contient le rang de chaque caractéristique. Le rang 1 correspond à la caractéristique la plus importante, tandis que le rang n correspond à la caractéristique la moins importante.")
    print(rfe.ranking_)
